package net.fusionlord.bukkit.skmcmmo.util.doc;

import net.fusionlord.bukkit.skmcmmo.skMcMMO;
...
public class Documentation {
	...
	private static File doc = new File(skMcMMO.INSTANCE.getDataFolder() + File.separator + "doc");
	...
	private static void css(){
		InputStream css = skMcMMO.INSTANCE.getResource("doc/css/style.css");
		InputStream bebas = skMcMMO.INSTANCE.getResource("doc/css/BebasNeueRegular.ttf");
		InputStream kirvy = skMcMMO.INSTANCE.getResource("doc/css/Kirvy-Regular.otf");
		InputStream icon = skMcMMO.INSTANCE.getResource("doc/css/favicon.ico");
	...
	private static InputStream resource(String dir){
		return skMcMMO.INSTANCE.getResource(dir);
	}
